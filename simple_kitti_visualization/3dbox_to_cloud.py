...
if __name__ == '__main__':
  ...
  # load point clouds
  scan_dir = f'/mnt/ssd/dataset/sequences/00/velodyne/{file_id}.bin'
  # scan_dir = f'/mnt/nas/KITTI object detection/training/velodyne/{file_id}.bin'
  scan = np.fromfile(scan_dir, dtype=np.float32).reshape(-1, 4)

  # load labels
  label_dir = f'/mnt/ssd/dataset/sequences/00/label_2/{file_id}.txt'
  # label_dir = f'/mnt/nas/KITTI object detection/training/label_2/{file_id}.txt'
